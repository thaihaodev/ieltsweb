...
import { SearchOutlined, ClockCircleOutlined, BarChartOutlined, CaretRightOutlined } from '@ant-design/icons';
import './listeningStyles.css';
...
const mockTests: ListeningTest[] = [
  { id: 1, title: 'Free ngẫu nhiên hàng tuần - Listening Test 11', duration: '30 - 36 phút', questions: '40 câu hỏi', status: 'Chưa làm bài', isFeatured: true },
  { id: 2, title: 'Listening Test 1', duration: '30 - 36 phút', questions: '40 câu hỏi', status: 'Chưa làm bài' },
  { id: 3, title: 'Listening Test 2', duration: '30 - 36 phút', questions: '40 câu hỏi', status: 'Chưa làm bài' },
  { id: 4, title: 'Listening Test 3', duration: '30 - 36 phút', questions: '40 câu hỏi', status: 'Chưa làm bài' },
  { id: 5, title: 'Listening Test 4', duration: '30 - 36 phút', questions: '40 câu hỏi', status: 'Chưa làm bài' },
  { id: 6, title: 'Listening Test 5', duration: '30 - 36 phút', questions: '40 câu hỏi', status: 'Chưa làm bài' },
];

// Component Card cho từng bài kiểm tra
const TestCard: React.FC<ListeningTest> = ({ title, duration, questions, status }) => (
    ...
    <Layout className="listening-tests-layout">
      ...
      <div className="header-bar">
        <Breadcrumb separator="/">
          ...
          <Breadcrumb.Item>Listening Tests</Breadcrumb.Item>
        </Breadcrumb>
      </div>
